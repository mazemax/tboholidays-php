...
class ArrayOfHotels implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param Hotels $value The value to set
     * @return void
     */
     ...
     *
     * @return Hotels Return the current element
     */
     ...
     *
     * @return Hotels Return count of elements
     */
