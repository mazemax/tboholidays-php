...
class ArrayOfCountryList implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param CountryList $value The value to set
     * @return void
     */
     ...
     *
     * @return CountryList Return the current element
     */
     ...
     *
     * @return CountryList Return count of elements
     */
